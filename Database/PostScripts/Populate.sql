...
IF NOT EXISTS (SELECT 1 FROM [dbo].[__EFMigrationsHistory] WHERE [MigrationId] IN ('00000000000000_CreateIdentitySchema'))
    BEGIN
        ...
        INSERT [dbo].[__EFMigrationsHistory] ([MigrationId], [ProductVersion]) VALUES (N'20230607095515_CreateItem', N'7.0.5')
        ...
        INSERT [dbo].[__EFMigrationsHistory] ([MigrationId], [ProductVersion]) VALUES (N'20230611062757_AddSpPlaceBid', N'7.0.5')
    END
