...
{
    /// <inheritdoc />
    public partial class CreateSpCategoryItems : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
				...
				/****** Object:  StoredProcedure [dbo].[spCategoryItems]    Script Date: 10/06/2023 4:16:56 pm ******/
				SET ANSI_NULLS ON
				GO
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
			migrationBuilder.Sql(@"
				...
				/****** Object:  StoredProcedure [dbo].[spCategoryItems]    Script Date: 10/06/2023 4:21:00 pm ******/
				DROP PROCEDURE [dbo].[spCategoryItems]
				GO
